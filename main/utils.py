...
def unique_key1_generator(instance):

    size = rondom.randint(15, 30)
    key = random_string_generator(size=size)
...
def unique_slug1_generator(instance, new_slug=None):
    """
    This is for a Django project and it assumes your instance 
    has a model with a slug field and a title character (char) field.
    """
...
def unique_slug2_generator(instance, new_slug=None):
    """
    This is for a Django project and it assumes your instance 
    has a model with a slug field and a title character (char) field.
    """
